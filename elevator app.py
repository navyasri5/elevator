...
if st.session_state.page == "Home":
    ...
    show_image("hero.jpg", caption="AI-powered elevator systems for luxury towers and industrial facilities")
    st.write("")
...
# ---------------------------------------------------------------------
    ...
    techs = [
        ("🔧", "Predictive Maintenance", "tech_predictive.jpg",
        ...
        ("📈", "Traffic Optimization", "tech_traffic.jpg",
         ...
         "times by up to 40%."),
        ("🔐", "Biometric & Touchless Integration", "tech_biometric.jpg",
...
# ---------------------------------------------------------------------
    ...
    show_image("residential_hero.jpg", caption="Luxury elevator interior in a high-rise residential tower")
    st.write("")
...
# ---------------------------------------------------------------------
    ...
    show_image("industrial_hero.jpg", caption="Industrial-grade elevator system at an oil refinery / hazardous facility")
    st.write("")
